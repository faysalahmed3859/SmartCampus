    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $(".category").click(function (e) {
                ...
                $(".brand").empty();
                $.ajax({
                    url: '/AcademicResources/GetAllSubCategory/?id=' + selectedCategoryId,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function (data) {
...
ShowInLargePopupPurchaQuotation = (url, title) => {
    $.ajax({
        ...
        success: function (res) {
            ...
            $trfirstclear.find("td").find('#price').val(0);
            $trfirstclear.find("td").find('#tax').val('');
            $trfirstclear.find("td").find('#product').val('');
            $trfirstclear.find("td").find('#rate').val(0);
            $trfirstclear.find("td").find('#discount').val(0);
            $trfirstclear.find("td").find('#quantity').val(0);
            $trfirstclear.find("td").find('#totalCost').val(0);
            $trfirstclear.find("td").find('#perProductCost').val(0);
            ...
            $('.datatable').on('change', '#tax', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var taxRate1 = curentrow.find('#rate')
                        taxRate1.val(data.rate)
                        console.log("rate val", taxRate1.val());
...
$(document).ready(function () {
    ...
    // Loop through each navigation link and compare its href with the current URL
...
function togglePasswordVisibilitys() {
    ...
    var passwordToggleIcon = document.getElementById("password-toggle-icons");
    ...
    $(document).ready(function () {
        $("#departmentDropdown").change(function () {
            ...
            $.get("/Home/GetSubjectsByDepartment", { departmentId: departmentId }, function (data) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $(".category").click(function (e) {
                ...
                $(".brand").empty();
                $.ajax({
                    url: '/Home/GetAllSubCategory/?id=' + selectedCategoryId,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function (data) {
                        $.each(data, function (i, obj) {
